package com.springboot.webflux.app.springbootwebfluxapirest.controllers;

import com.springboot.webflux.app.springbootwebfluxapirest.models.documents.Producto;
import com.springboot.webflux.app.springbootwebfluxapirest.models.service.ProductoService;
...
public class ProductoController {
    ...
    public Mono<ResponseEntity<Producto>> crearConFoto(Producto producto, @RequestPart FilePart file) {
        ...
        return file.transferTo(new File(path + producto.getFoto()))
                .then(service.save(producto)).map(p -> ResponseEntity
